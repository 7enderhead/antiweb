...
class Test_Antiweb(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.origin_path = os.path.join(self.tests_dir, os.path.join("unittest", "small_testfile.py"))
    ...
    def test_antiweb_i_o(self):
        compare_path_small_testfile = os.path.join(self.tests_dir, os.path.join("unittest","small_testfile.rst"))
        compare_path_index = os.path.join(self.tests_dir, os.path.join("unittest","index_o.rst"))
        self.test_args = ['antiweb.py', '-i', "-o", self.doc_dir, os.path.join(self.test_dir, "small_testfile.py")]
    ...
    def test_antiweb_o(self):
        compare_path_small_testfile = os.path.join(self.tests_dir, os.path.join("unittest","small_testfile.rst"))
        self.test_args = ['antiweb.py', "-o", self.doc_dir, os.path.join(self.test_dir, "small_testfile.py")]
    ...
    def test_antiweb_i(self):
        compare_path_small_testfile = os.path.join(self.tests_dir, os.path.join("unittest","small_testfile.rst"))
        compare_path_index = os.path.join(self.tests_dir, os.path.join("unittest","index.rst"))
    ...
    def test_antiweb_r_i_o(self):
        compare_path_small_testfile = os.path.join(self.tests_dir, os.path.join("unittest","docs","small_testfile.rst"))
        compare_path_index = os.path.join(self.tests_dir, os.path.join("unittest", self.doc_dir,"index.rst"))
        self.test_args = ['antiweb.py', '-i', "-o" , self.doc_dir, "-r", os.path.join(self.test_dir)]

        with patch.object(sys, 'argv', self.test_args):
            self.functional(self.doc_dir, "small_testfile.rst", compare_path_small_testfile, main())
            self.functional(self.doc_dir, "index.rst", compare_path_index, os.path.isfile(os.path.join(self.test_dir, self.doc_dir, "index.rst")))
    ...
    def test_antiweb_r_o(self):
        compare_path_small_testfile = os.path.join(self.tests_dir, os.path.join("unittest", "docs", "small_testfile.rst"))
        self.test_args = ['antiweb.py',"-o", self.doc_dir, "-r", os.path.join(self.test_dir)]

        with patch.object(sys, 'argv', self.test_args):
            self.functional(self.doc_dir, "small_testfile.rst", compare_path_small_testfile, main())
            self.file_not_exist(os.path.join(self.test_dir, self.doc_dir, "index.rst"))
...
class Test_Antiweb_rst(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_dir = tempfile.mkdtemp()
        print(self.test_dir)
        self.origin_path = os.path.join(self.tests_dir, os.path.join("unittest_rst", "ein_rst.rst"))
    ...
    def test_antiweb_rst_i_o(self):
        compare_path_small_testfile = os.path.join(self.tests_dir, os.path.join("unittest_rst","ein_rst_docs.rst"))
        compare_path_index = os.path.join(self.tests_dir, os.path.join("unittest_rst","index_o.rst"))
        self.test_args = ['antiweb.py', '-i', "-o", self.doc_dir, os.path.join(self.test_dir, "ein_rst.rst")]
    ...
    def test_antiweb_rst_o(self):
        compare_path_small_testfile = os.path.join(self.tests_dir, os.path.join("unittest_rst","ein_rst_docs.rst"))
        self.test_args = ['antiweb.py', "-o", self.doc_dir, os.path.join(self.test_dir, "ein_rst.rst")]
    ...
    def test_antiweb_rst_i(self):
        compare_path_small_testfile = os.path.join(self.tests_dir, os.path.join("unittest_rst","ein_rst_docs.rst"))
        compare_path_index = os.path.join(self.tests_dir, os.path.join("unittest_rst","index.rst"))
    ...
    def test_antiweb_rst_r_i_o(self):
        compare_path_small_testfile = os.path.join(self.tests_dir, os.path.join("unittest_rst","docs","ein_rst.rst"))
        compare_path_index = os.path.join(self.tests_dir, os.path.join("unittest_rst", self.doc_dir,"index.rst"))
        self.test_args = ['antiweb.py', '-i', "-o" , self.doc_dir, "-r", os.path.join(self.test_dir)]
