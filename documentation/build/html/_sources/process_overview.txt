...
.. csv-table::
   ...
   Use antiweb to create rst files and add them to Sphinx' index.rst
...
====================   
   ...
   ::
      ...
      antiweb.py /path/to/project -r -i -o foldername
...
Make sure all of your ``.rst`` files are stored inside the source folder and that they are registered inside the index.html (which is also located inside your source folder)
