...
%
% lighter color for code block border
\\definecolor{VerbatimBorderColor}{rgb}{0.8,0.8,0.8}
%
% code block settings via fancyvrb keywords
\\fvset{baselinestretch=1.22}''',

     # Latex figure (float) alignment
     #
     # 'figure_align': 'htbp',

	 'fontpkg': '''\\usepackage[largesmallcaps,oldstylenums]{kpfonts}
\\usepackage[sf,scale=0.9]{merriweather}
\\usepackage{microtype}
% renew typewriter font without old-style numbers
